 ...
 * @endcode
 */
$settings['hash_salt'] = 'EvIi0kR7V5DzekV8Y8URFsJf4dqsUGIH6OTijCT1FMVWbIkCJjWgSYny2I4xt7wBq3UYsIs5vA';
...
# }
$databases['default']['default'] = array (
  'database' => 'drupal-besp-report-dev',
  'username' => 'root',
  'password' => 'mp8itall',
  'prefix' => '',
  'host' => 'localhost',
...
$content_directories['sync'] = $app_root.'/../content_sync';

$config_directories['sync'] = $app_root.'/../config_sync';
$config_directories[CONFIG_SYNC_DIRECTORY] = $app_root.'/../config_sync';
